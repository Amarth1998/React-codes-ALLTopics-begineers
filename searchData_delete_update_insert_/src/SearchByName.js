...
const SearchByName = () => {
   ...
   return (
      ...
      <div style={{width:"50%" ,margin:"auto"}}> 
         <h1  style={{textAlign:"center"}}> Search by Student name</h1>
         <center> <label htmlFor="">Enter Student Name</label>  <br /><input type="text" value={snm} onChange={handleInput} style={{border:"1px solid black" ,width:"40%" }} />
         </center> </div> <br />
